...
import ColumnPelatihan from "./table/columnPelatihan";
  ...
  return (
    <div className="px-4 py-5">
      <section className="flex items-center justify-between w-full">
        <article>
          <h4 className="text-sm font-semibold">Pelatihan</h4>
      ...
      <div className="flex items-center py-2 text-xs"></div>
