...
import { HiChevronUpDown, HiBuildingLibrary } from "react-icons/hi2";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          <div className="flex w-full items-center border-b px-4 h-[60px] lg:px-6">
            <DropdownMenu
              href="/"
              className="flex w-full items-center gap-2 font-semibold py-4"
            >
              <DropdownMenuTrigger className="flex w-full items-center justify-between">
                <div className="flex items-center  space-x-2">
                  <HiBuildingLibrary className="h-6 w-6" />
                  <span className="">JobBridge</span>
                </div>
